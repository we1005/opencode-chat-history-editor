...
| 🔎 | **搜索与定位** | 搜索后跳回原始消息流阅读上下文；复制会话 ID 或直达链接 |
...
2. **找消息**：搜索正文、思考、工具或错误。点击命中消息上的 **查看上下文**，恢复完整消息流并定位、高亮该消息，向上 / 向下阅读前后文。搜索词会保留，可点击 **返回搜索结果** 继续查找；浏览较远后可用 **回到定位消息** 重新定位。工具可单独展开，也可使用“展开全部工具输出”。
